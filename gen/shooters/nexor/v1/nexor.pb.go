...
func (x *SayHelloResponse) Reset() {
	*x = SayHelloResponse{}
	mi := &file_shooters_nexor_v1_nexor_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SayHelloResponse) Descriptor() ([]byte, []int) {
	return file_shooters_nexor_v1_nexor_proto_rawDescGZIP(), []int{3}
}
...
const file_shooters_nexor_v1_nexor_proto_rawDesc = "" +
	...
	"\aproduct\x18\x02 \x01(\v2!.shooters.nexor.v1.ProductCreatedR\aproduct\"%\n" +
	...
	"NexorProtoP\x01Z/github.com/rimdesk/rimnats/gen/shooters/nexor/v1\xa2\x02\x03SNX\xaa\x02\x11Shooters.Nexor.V1\xca\x02\x11Shooters\\Nexor\\V1\xe2\x02\x1dShooters\\Nexor\\V1\\GPBMetadata\xea\x02\x13Shooters::Nexor::V1b\x06proto3"
...
var file_shooters_nexor_v1_nexor_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_shooters_nexor_v1_nexor_proto_goTypes = []any{
	(*ProductCreated)(nil),   // 0: shooters.nexor.v1.ProductCreated
	(*Event)(nil),            // 1: shooters.nexor.v1.Event
	(*SayHelloRequest)(nil),  // 2: shooters.nexor.v1.SayHelloRequest
	(*SayHelloResponse)(nil), // 3: shooters.nexor.v1.SayHelloResponse
}
var file_shooters_nexor_v1_nexor_proto_depIdxs = []int32{
	0, // 0: shooters.nexor.v1.Event.product:type_name -> shooters.nexor.v1.ProductCreated
